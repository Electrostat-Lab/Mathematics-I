...
>                 $$= N_i + N_{i+1} + N_{i+2} + ... + N_{I-2} + N_{I-1} + N_{I}$$; where $I$ is the total number of loop closures, and it represents the finite-item in the set.
> 
...
> - Riemann's sums can applied for a finite-set of conditional closures execution, so $$f(I) = \sum_{i=1}^{I} f(N_{i}) $$
>   
